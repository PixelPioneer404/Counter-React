                ...
                <div className="z-999 w-[30%] h-[50%] rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white grid grid-rows-[20%_1fr] gap-4">
                    ...
                    <div className="w-full flex justify-start items-center p-4 flex-col overflow-y-auto [&>*:nth-child(odd)]:bg-gray-200 [&>*]:p-2 [&>*]:rounded-lg">
                        <div
                            ...
                            className="w-full flex justify-between items-center h-12 cursor-pointer hover:bg-gray-100 transition-colors duration-200 rounded-lg px-2"
                        >
                            <p className="text-md text-[#191923] font-sans font-normal pointer-events-none">Go beyond zero</p>
                            <Switch
                                ...
                                className={`${props.is1Checked ? 'bg-green-500' : 'bg-gray-300'} relative inline-flex h-6 w-10 items-center rounded-full transition-colors duration-200 ease-in-out focus:outline-none cursor-pointer pointer-events-none`}
                            >
                                <span
